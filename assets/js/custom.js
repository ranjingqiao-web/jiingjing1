...
function contactValidator() {
    ...
    let chuhaiHtml =` <div class="col-md-6 col-lg-4 service-content">
  ...
  <div class="col-md-6 col-lg-4 service-content">
    <div class="services-item p-relative text-center background-section no-shadow">
      <div class="bg-section background-section p-absolute w-100 h-100 over-hidden"></div>
      <div class="box-content p-relative d-flex align-items-center h-100">
        <div class="content-inner">
          <div class="icon"><img src="assets/img/services/2.png" alt=""></div>
          <div class="content">
            <h4 class="title-block ">海外营销</h4>
            <p class="p-absolute">包括国际市场洞察、运营优化、数字创意、网红KOL营销服务</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="services-item p-relative text-center background-section no-shadow">
      ...
      <div class="box-content p-relative d-flex align-items-center h-100">
        <div class="content-inner">
          ...
          <div class="content">
            <h4 class="title-block ">智能技术数据分析</h4>
            <p class="p-absolute">用数据技术平台支持跨境出海行业数字化推广运营分析</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-md-6 col-lg-4 service-content">
    <div class="services-item p-relative text-center background-section no-shadow">
      ...
      <div class="box-content p-relative d-flex align-items-center h-100">
        <div class="content-inner">
          <div class="icon"><img src="assets/img/services/4.png" alt=""></div>
          <div class="content">
            <h4 class="title-block ">创意制作与页面设计</h4>
            <p class="p-absolute">根据客户需求定制广告落地页和输出广告素材</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-md-6 col-lg-4 service-content">
    <div class="services-item p-relative text-center background-section no-shadow">
      ...
      <div class="box-content p-relative d-flex align-items-center h-100">
        <div class="content-inner">
          <div class="icon"><img src="assets/img/services/5" alt=""></div>
          <div class="content">
            <h4 class="title-block ">政策咨询与产品指导</h4>
            <p class="p-absolute">提供最新海外政策动态和分析产品​品牌策略</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-md-6 col-lg-4 service-content">
    <div class="services-item p-relative text-center background-section no-shadow">
      ...
      <div class="box-content p-relative d-flex align-items-center h-100">
        <div class="content-inner">
          <div class="icon"><img src="assets/img/services/6" alt=""></div>
          <div class="content">
            <h4 class="title-block ">海外本土化支持</h4>
            <p class="p-absolute">本地团队覆盖全球 26种语言落地</p>
          </div>
        </div>
      </div>
    </div>
