(function ($) {
  ...
  let jjfaHtml = `<div class="work-container over-hidden">
  ...
  let indexHtml = `<div class="slick-slider">
     <div class="work-item slick-slide p-relative over-hidden">
       ...
       <div class="item-info p-absolute"> <a href="javascript:;" class="effect-ajax" data-dsn-ajax="work">
           <h5 class="cat">出海解决方案</h5>
           <h4>游戏出海</h4>
           <h4> 资深游戏出海服务团队，整合全球数字媒体流量和服务优势，通过强大的技术保障和产品，为出海游戏发行商提供出海增长一站式解决方案，助其逐鹿海外。 </h4>
           <span><span></span></span>
         </a> </div>
     </div>
     <div class="work-item slick-slide p-relative over-hidden">
       ...
       <div class="item-info p-absolute"> <a href="javascript:;" data-dsn-grid="move-up" class="effect-ajax"
           ...
           <h5 class="cat">出海解决方案</h5>
           <h4>电商出海</h4>
           <h4> 深度整合全球数字媒体流量，以商业智能为基础，为商家提供跨境商城一站式建设、全闭环代运营直播等服务，帮助国内卖家落地海外，在全球市场取得成功。 </h4>
           <span><span></span></span>
         </a> </div>
     </div>
     <div class="work-item slick-slide p-relative over-hidden">
     ...
     <div class="work-item slick-slide p-relative over-hidden">
       ...
       <div class="item-info p-absolute"> <a href="javascript:;" data-dsn-grid="move-up" class="effect-ajax"
           ...
           <h5 class="cat">出海解决方案</h5>
           <h4>金融科技出海</h4>
           <h4>整合行业内顶尖金融数字化转型上的经验和技术创新能力，一起构建行业领先的解决方案，拓展全球市场，做大金融科技蛋糕，共创金融行业新价值，实现商业共赢。</h4>
           <span><span></span></span>
         </a> </div>
     </div>
     <div class="work-item slick-slide p-relative over-hidden">
       ...
       <div class="item-info p-absolute"> <a href="javascript:;" data-dsn-grid="move-up" class="effect-ajax"
           ...
           <h5 class="cat">出海解决方案</h5>
           <h4>短剧出海</h4>
           <h4>提供一站式短剧音视频平台，智能解码音频，全球播放加速，防止版权被盗，降低短剧开发成本，带来高流量高转化。</h4>
           <span><span></span></span>
         </a> </div>
     </div>
     <div class="work-item slick-slide p-relative over-hidden">
       ...
       <div class="item-info p-absolute"> <a href="javascript:;" data-dsn-grid="move-up" class="effect-ajax"
           ...
           <h5 class="cat">出海解决方案</h5>
           <h4>品牌出海</h4>
           <h4>从中国制造到中国创造，品牌出海成当前出海主流趋势。我们基于人工智能创意内容生成技术，并独有定制化全栈品牌出海服务，帮助国内企业塑造海外品牌，打造穿越周期的国际竞争力。</h4>
           <span><span></span></span>
         </a></div>
     </div>
     <div class="work-item slick-slide p-relative over-hidden">
       ...
       <div class="item-info p-absolute"><a href="javascript:;" data-dsn-grid="move-up" class="effect-ajax"
           ...
           <h5 class="cat">出海解决方案</h5>
           <h4>社媒运营</h4>
           <h4>通过社交媒体营销策略，驱动企业目标及营销结果提升，增加产品曝光，吸引更多的潜在客户，提高品牌在各大社媒平台的影响力。</h4>
           <span><span></span></span>
         </a> </div>
     </div>
     <div class="work-item slick-slide p-relative over-hidden">
       ...
       <div class="item-info p-absolute"> <a href="javascript:;" data-dsn-grid="move-up" class="effect-ajax"
           ...
           <h5 class="cat">出海解决方案</h5>
           <h4>红人营销</h4>
           <h4>帮助客户拓展、招募和发展契合的海外内容营销伙伴，在一站式海外网红营销管理平台上，获取全渠道的网红内容绩效数据。</h4>
           <span><span></span></span>
         </a> </div>
     </div>
   </div>`;
  ...
  function reloadAjax($off) {
    ...
    setTimeout(function () {
      ...
      if (!$off) menuP = effctStickyNavBar();
      else if (menuP) {
        menuP.t1.kill();
        menuP.t2.kill();
        $('.site-header').css({
    ...
    return {
      ...
      bySlick: function ($id, $obj) {
        dsnGrid.convertToJQuery($id).each(function () {
          ...
          if ($(this).hasClass('dsn-is-not-fade')) $obj['fade'] = false;
  ...
  function dsnAjax() {
    ...
    return {
      ...
      setTitle: function (data) {
        ...
        if (title) $('head title').html(title[1]);
        title = null;
      },
      setBodyClass: function (data) {
        let cls = data.match(/<body[^>]*class="(.+)">/);
        if (cls) body.attr('class', cls[1]);
        cls = null;
      },
      ajaxNormal: function () {
      ...
      dsnCreateElement: function ($e, $target, $letter, $targetLtter) {
        ...
        if (img_move) img_move.css('z-index', 1);
      ...
      completeElement: function (elAjax) {
        ...
        if (title_move.length) {
          ...
          if (title.parents('.v-middle-horizontal').length) title_move.css('width', 'max-content');
          else title_move.css('width', title.width());

          if (title.find('.dsn-chars-wrapper').length) {
            let currTrans = title.find('.dsn-chars-wrapper').css('transform').split(/[()]/)[1];
            if (currTrans) currTrans = currTrans.split(',')[5];
            if (currTrans)
              tl.staggerTo(
      ...
      animateAjaxStart: function (_type, _that) {
        tl = new TimelineMax();
        if (_type === 'slider') this.ajaxSlider(_that);
        else if (_type === 'next') this.ajaxNextProject(_that);
        else if (_type === 'work') this.ajaxWork(_that);
        else this.ajaxNormal();
      ...
      animateAjaxEnd: function (data) {
        ...
        setTimeout(
          function () {
            ...
            if (elAjax.hasClass('dsn-ajax-normal')) tl.to(elAjax, 1, { scaleY: 0 });
            else this.completeElement(elAjax);
  ...
  function effctStickyNavBar() {
    ...
    tl.to('.header-top .header-container, .site-header ', 0.5, {
      backgroundColor: '#000',
      paddingTop: 15,
      paddingBottom: 15
    });
        ...
        p.find('button').on('click', function () {
          ...
          $this.justifiedGallery({
            filter: function (entry, index, array) {
              if (!$(entry).is(b))
                TweenLite.to(entry, 0.1, {
                  scale: 0,
                  ease: Back.easeIn.config(1.2)
                });
              else
                TweenLite.to(entry, 0.6, {
                  scale: 1,
  ...
  function navMenu() {
    ...
    return {
      lineActive: function () {
        ...
        if (activeNav.length) this.setLine(activeNav.offset().left);
        activeNav = null;
      },
      lineMove: function () {
        let $parent = this;
      ...
      hamburgerOpen: function () {
        ...
        tl.to(mainNav.find('ul.extend-container > li > a .dsn-meta-menu'), 0.5, { autoAlpha: 1, ease: Ease });
        ...
        mainNav.find('ul.extend-container > li.dsn-drop-down').on('click', function (e) {
          ...
          menuClick.staggerTo(mainNav.find('ul.extend-container > li > a .dsn-title-menu'), 0.5, { y: -30, autoAlpha: 0, ease: Back.easeIn.config(1.7) }, 0.1);

          menuClick.to(mainNav.find('ul.extend-container > li > a .dsn-meta-menu'), 0.5, { autoAlpha: 0 }, 0.5);
  ...
  function effectAnimate() {
    ...
    return {
      ...
      headerPages: function () {
        ...
        if (parallaxProject) scene.push(parallaxProject);
      ...
      headerProject: function () {
        ...
        if (heroTitle.length) {
          ...
          if (heroDec.length) TweenLite.set(heroTitle.find('.dsn-chars-wrapper , .metas'), { y: '+=' + heroDec.height() });
          if (heroDecItem.length) TweenLite.set(heroTitle.find('.dsn-chars-wrapper , .metas'), { y: '+=' + (heroDecItem.height() - 30) });

          parallax.to(
            heroTitle.find('.metas'),
            1,
            {
              force3D: true,
              y: '0',
        ...
        //--> Hero Fill Title
        if (heroDec.length) parallax.fromTo(heroDec, 0.8, { y: '15%', autoAlpha: 0 }, { y: '0%', autoAlpha: 1 });

        //--> Hero Fill Title
        if (heroDecItem.length) parallax.fromTo(heroDecItem, 0.3, { y: '15%', autoAlpha: 0 }, { y: '0%', autoAlpha: 1 });

        //--> Hero Fill Title
        if (heroDecItems.length)
          parallax.staggerFromTo(
            heroDecItems,
            1,
            { y: '15%', autoAlpha: 0 },
            {
      ...
      nextProject: function () {
        ...
        let heroTitle = $('#dsn-footer-title'),
        ...
        if (heroImg.length) {
          ...
          parallax.to(
            ...
            2,
            {
              value: '75%',
              onUpdate: function () {
                heroImg.css('background-image', 'linear-gradient(to left, #000 ' + parX.value + ', rgba(0, 0, 0, 0.26) 100%)');
              }
            },
            0
          );
      ...
      animateFade: function () {
        ...
        $element.each(function () {
          ...
          if ($this.hasClass('dsn-animate')) tl.fromTo(this, 1, { y: 50, opacity: 0 }, { y: 0, opacity: 1 });
      ...
      sectionWork: function () {
        ...
        if (sectionWork.length) {
          ...
          if (dsnGrid.isMobile() && wind.width() < 768 && wind.width() >= 576) widtSection = wind.width() / 1.5;
          else if (dsnGrid.isMobile() && wind.width() < 576) widtSection = wind.width() / 1.15;
  ...
  return {
    ...
    initSlider: function () {
      ...
      slid_items.each(function ($index) {
        ...
        if (!$parent.isDemoSlide()) $object.push($parent.nextSlide(title.text(), slide_content.find('.metas').html(), $(this).find('.image-bg').clone()));
      ...
      swiper.on('progress', function () {
        ...
        for (let i = 0; i < swiper.slides.length; i++) {
          let slideProgress = swiper.slides[i].progress,
            ...
            trns = $isVertical ? 'Y' : 'X';
          swiper.slides[i].querySelector('.image-bg').style.transform = 'translate' + trns + '(' + innerTranslate + 'px) ' + 'skew' + trns + '(' + innerTranslate / 50 + 'deg)';
    ...
    slideChange: function (swiper) {
      ...
      function start() {
        ...
        tl.staggerFromTo(content_letterOld, 0.3, $this.showText().title, $this.hideText($isRight).title, 0.05, 0, function () {
          dsn_slider.find('.dsn-slider-content .slide-content').removeClass('dsn-active').removeClass('dsn-active-cat');
          contentNew.addClass('dsn-active');
          contentNew.addClass('dsn-active-cat');
        });

        tl.staggerFromTo(dsnGrid.randomObjectArray(content_letterNew, 0.8), 0.8, $this.hideText(!$isRight).title, $this.showText().title, 0.05, '-=.1');
    ...
    run: function () {
      ...
      if (this.isDemoSlide() && !dsn_slider.hasClass('has-loop')) swiper.slideTo(1);
...
function services_tab($off) {
  if ($off) $('.services-about .link-click').off('click');
...
function contactValidator() {
    ...
    /* <div class="services-item p-relative text-center background-section no-shadow">
          ...
          <div class="box-content p-relative d-flex align-items-center h-100">
            <div class="content-inner">
              <div class="icon"><img src="assets/img/services/1" alt=""></div>
              <div class="content">
                <h4 class="title-block ">媒体采买</h4>
                <p class="p-absolute">海外网络和数字媒体资源平台流量购买和广告账号运营管理</p>
              </div>
            </div>
          </div>
        </div> */
  ...
  let chuhaiHtml = ` <div class="col-md-6 col-lg-4 service-content"  style="    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;">

    <div class="content-inner" style="    text-align: center;" >
          <div class="icon"    text-align: center;><img    src="assets/img/services/1" alt=""></div>
          <div class="content">
            <h4 style="margin:20px 0" >媒体采买</h4>
            <p  style="    width: 64%;margin: 0 auto;">海外网络和数字媒体资源平台流量购买和广告账号运营管理</p>
          </div>
        </div>
     
  </div>
  <div class="col-md-6 col-lg-4 service-content"  style="display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;">
  <div class="content-inner" style=" text-align: center;" >
  <div class="icon"><img style="width:50px"  src="assets/img/services/2.png" alt=""></div>
  <div class="content">
    <h4 class=" " style="margin:20px 0" >海外营销</h4>
    <p class=" "  style="    width: 64%;margin: 0 auto;">包括国际市场洞察、运营优化、数字创意、网红KOL营销服务</p>
  </div>
</div>
  </div>
  <div class="col-md-6 col-lg-4 service-content"  style="    display: flex;
  ...
  justify-content: center;">
  <div class="content-inner"  style=" text-align: center;" >
  <div class="icon"><img src="assets/img/services/3.png.webp" alt=""></div>
  <div class="content">
    <h4  style="margin:20px 0" >智能技术数据分析</h4>
    <p   style="    width: 64%;margin: 0 auto;">用数据技术平台支持跨境出海行业数字化推广运营分析</p>
  </div>
</div>
  </div>
  <div class="col-md-6 col-lg-4 service-content"  style="    display: flex;
  ...
  justify-content: center;">
  <div class="content-inner" style=" text-align: center;" >
  <div class="icon"><img  style="width:50px"   src="assets/img/services/4.png" alt=""></div>
  <div class="content">
    <h4  style="margin:20px 0" >创意制作与页面设计</h4>
    <p  style="    width: 64%;margin: 0 auto;" >根据客户需求定制广告落地页和输出广告素材</p>
  </div>
</div>
  </div>
  ...
  justify-content: center;">
  <div class="content-inner" style=" text-align: center;" >
  <div class="icon"><img  style="width:50px"   src="assets/img/services/5.png" alt=""></div>
  <div class="content">
    <h4  style="margin:20px 0" >政策咨询与产品指导</h4>
    <p  style="    width: 64%;margin: 0 auto;" >提供最新海外政策动态和分析产品​品牌策略</p>
  </div>
</div>
  </div>
  ...
  justify-content: center;">
  <div class="content-inner" style=" text-align: center;" >
  <div class="icon"><img  style="width:50px"   src="assets/img/services/6.png" alt=""></div>
  <div class="content">
    <h4  style="margin:20px 0" >海外本土化支持</h4>
    <p  style="    width: 64%;margin: 0 auto;" >本地团队覆盖全球 26种语言落地</p>
  </div>
</div>
  </div>
  ...
  window.$crisp = [];
  window.CRISP_WEBSITE_ID = '16f31e7f-3872-416c-8002-2339dad82cee';
  (function () {
    d = document;
